    ...
    >
      <div>
        ...
        <Input
          ...
          // error and disabled states handled by Input
        />
...
const ExpensePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{softwareName} | Expense</title>
        <meta name="description" content="Manage expenses for your copper wire manufacturing management system." />
      </Helmet>
      <DashboardLayout>
